...
| Command | Mean [ms] | Min [ms] | Max [ms] | Relative |
|:---|---:|---:|---:|---:|
| `fhessel` | 75.6 ± 3.5 | 71.1 | 89.4 | 437.88 ± 856.33 |
| `CryptoCopter` | 55.8 ± 3.4 | 50.3 | 66.7 | 323.05 ± 631.90 |
| `s1effen` | 0.2 ± 0.3 | 0.0 | 4.9 | 1.00 |
| `gh0st42` | 1.4 ± 0.4 | 1.0 | 5.9 | 8.08 ± 16.00 |
...
| s1effen | [904975d](https://github.com/LOEWE-emergenCITY/AdventOfCode2022/tree/904975d05a3edbd819a7107eeb78aaf076101e38/08) | [stdout](08/s1effen.txt) [stderr](08/s1effen-stderr.txt) |
...
| Command | Mean [ms] | Min [ms] | Max [ms] | Relative |
|:---|---:|---:|---:|---:|
| `fhessel` | 2.6 ± 0.1 | 2.5 | 3.8 | 1.00 |
| `CryptoCopter` | 14.3 ± 0.2 | 14.1 | 15.4 | 5.43 ± 0.16 |
| `fput` | 4.3 ± 0.3 | 4.0 | 8.8 | 1.63 ± 0.11 |
